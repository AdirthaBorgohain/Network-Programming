...
int main(void)
{
    ...
    serv_addr.sin_port = htons(16012);    
    ...
    while(1)
    {
        ...
        else if(recvBuff[0]=='O' || recvBuff[0]=='o')
        {
        ...
        else if(recvBuff[0]=='G' || recvBuff[0]=='g')
        {   
        ...
        else if(recvBuff[0]=='B' || recvBuff[0]=='b')
        {
